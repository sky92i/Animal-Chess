...
public class Model {
    public static GameBoard createBoard() {
        ...
        for (int j = 0; j < 7; j++) {
            for (int i = 0; i < 9; i++) {
                ...
                if (i == 0 && j == 0) temp.setPiece("A7");
                if (i == 2 && j == 0) temp.setPiece("A1");
                if (i == 6 && j == 0) temp.setPiece("B8");
                if (i == 8 && j == 0) temp.setPiece("B6");

                if (i == 1 && j == 1) temp.setPiece("A3");
                if (i == 7 && j == 1) temp.setPiece("B2");

                if (i == 2 && j == 2) temp.setPiece("A5");
                if (i == 6 && j == 2) temp.setPiece("B4");

                if (i == 0 && j == 3) temp.setPiece("Dn");
                if (i == 8 && j == 3) temp.setPiece("Dn");

                if (i == 2 && j == 4) temp.setPiece("A4");
                if (i == 6 && j == 4) temp.setPiece("B5");

                if (i == 1 && j == 5) temp.setPiece("A2");
                if (i == 7 && j == 5) temp.setPiece("B3");

                if (i == 0 && j == 6) temp.setPiece("A6");
                if (i == 2 && j == 6) temp.setPiece("A8");
                if (i == 6 && j == 6) temp.setPiece("B1");
                if (i == 8 && j == 6) temp.setPiece("B7");

                if ((i == 3 || i == 4 || i == 5) && (j == 1 || j == 2 || j == 4 || j == 5)) temp.setPiece("~~");
                if((i == 0) && (j == 2 || j == 4) || (i == 1 && j == 3)) temp.setPiece("++");
                if((i == 8) && (j == 2 || j == 4) || (i == 7 && j == 3)) temp.setPiece("++");
    ...
    public static GameBoard Move(String piece, int x, int y, GameBoard gameboard){
        for (int i = 0; i < 9; i++) {
            for (int j = 0; j < 7; j++) {
                if(Objects.equals(gameboard.GBoard[i][j].getPiece(), piece)){
    ...
    public static boolean isValidMove(int i, int j, int x, int y, GameBoard gameboard) {
    ...
    public static void addBackTrapWaterSign(GameBoard gameboard){
    ...
    public static boolean isTheRatInWater(int i, int j){
        return (i == 3 && (j == 1 || j == 2 || j == 4 || j == 5)) || (i == 4 && (j == 1 || j == 2 || j == 4 || j == 5)) ||
                (i == 5 && (j == 1 || j == 2 || j == 4 || j == 5));
    }

    public static boolean isTigerLionNearWater(int i, int j, int x, int y, GameBoard gameboard){
        int a = Character.getNumericValue(gameboard.GBoard[i][j].getPiece().charAt(1));
        if (a == 6 || a == 7){
